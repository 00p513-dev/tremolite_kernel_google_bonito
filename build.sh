...
git clone https://github.com/00p513-dev/AnyKernel3.git -b bonito --depth=1 AnyKernel
...
export ARCH=arm64
export KBUILD_BUILD_USER=tremolite
export KBUILD_BUILD_HOST=tremolite
...
zipping() {
    ...
    zip -r9 tremolite-bonito-${TANGGAL}.zip *
    cd ..
}
